...
CC = cc
# Source Files #
SRC = $(SRCDIR)main/minishell.c $(SRCDIR)ui/ui.c $(SRCDIR)executor/ms_executor.c $(SRCDIR)executor/ms_heredoc.c $(SRCDIR)debug/debug.c $(SRCDIR)init/ms_cleanup_utils.c $(SRCDIR)init/ms_init.c
